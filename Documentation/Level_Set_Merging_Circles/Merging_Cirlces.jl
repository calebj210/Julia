...
function hexNoReinit(N; n, m, o, r, c, maxIts=250, Δt, tf)
    ...
    # Generate node band
    nodes = hexGen(4N, minx=-(c+2r), maxx=(c+2r), miny=-(c+2r), maxy=(c+2r))
    N = size(nodes,2)
    ...
    plotA = scatter(zeroSet[1,:],zeroSet[2,:],
                    ...
                    markersize = 2,
                    dpi = 300)
    savefig(plotA, string("hex_",0,".png"))
    ...
    for i∈time
        ...
        if k%1000 == 0
            ...
            #                       ε=10^(-10), maxIts=5)
            zeroSet = coulNewtonAdapt(zeroSet, nodes, f, n=n, m=m, o=o, maxIts=100, μ=1.9, Δt=10^(-5), ε=10^(-10))
            ...
            savefig(plotA, string("hex_",k,".png"))
        end
...
function hexWithReinit(N; n, m, o, r, c, maxIts=250, Δt, tf)
    ...
    for i∈time
        ...
        if reset >= 100
            # zeroSet = newtonSolve(zeroSet, nodes, f, n=n, m=m, o=o,
            #                       ε=10^(-10), maxIts=5)
            zeroSet = coulNewtonAdapt(zeroSet, nodes, f, n=n, m=m, o=o, maxIts=50, μ=1.9, Δt=10^(-5), ε=10^(-10))
...
function narrowBandNoReinit(N; n, m, o, r, c, maxIts=250, Δt, tf)
    ...
    plotA = scatter(zeroSet[1,:],zeroSet[2,:],
                    ...
                    markersize = 2,
                    dpi = 300)
    savefig(plotA, string("narrowBand_",0,".png"))
    ...
    for i∈time
        ...
        if k%1000 == 0
            ...
            savefig(plotA, string("narrowBand_",k,".png"))
...
function hexBandNoReinit(N; n, m, o, r, c, maxIts=250, Δt, tf)
    ...
    nodes = hexBand(zeroSet, hexGen(4N, minx=-(c+2r), maxx=(c+2r), miny=-(c+2r), maxy=(c+2r)), n=10)
    N = size(nodes,2)
    ...
    plotA = scatter(zeroSet[1,:],zeroSet[2,:],
                    ...
                    markersize = 2,
                    dpi=300)
    savefig(plotA, string("hexBand_",0,".png"))
    ...
    for i∈time
        ...
        if k%1000 == 0
            ...
            savefig(plotA, string("hexBand_",k,".png"))
...
# Run test function
hexNoReinit(100, n=11, m=5, o=2, r=1, c=0.8, Δt=10^(-5), tf=0.09)

# hexWithReinit(100, n=11, m=5, o=2, r=1, c=0.8, Δt=10^(-4), tf=0.1)

narrowBandNoReinit(100, n=11, m=5, o=2, r=1, c=0.8, Δt=10^(-5), tf=0.09)

hexBandNoReinit(100, n=11, m=5, o=2, r=1, c=0.8, Δt=10^(-5), tf=0.09)
