...
function findNormals(nodes, n, m, o)
    ...
    # Set appNorms to true norms
    # t = range(0,2*π-2*π/N, length = N);
    # appNorms = [piNormsX.(t)'; piNormsY.(t)'];
...
function comp(N=100, n=10, m1=3, o=n-1)
    ...
    t = range(Double64(0),Double64(2)*π-Double64(2)*π/N, length = N);
